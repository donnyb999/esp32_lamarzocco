...
2.  **Build using Docker**:
    ...
    /bin/bash -c "git config --global --add safe.directory '*' && make -C mpy-cross && make -C ports/esp32 BOARD=ESP32_GENERIC_S3 BOARD_VARIANT=SPIRAM_OCT submodules && make -C ports/esp32 BOARD=ESP32_GENERIC_S3 BOARD_VARIANT=SPIRAM_OCT"
    ```
